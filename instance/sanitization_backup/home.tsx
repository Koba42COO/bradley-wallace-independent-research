...
export default function Home() {
	...
	return (
		<div className="relative flex size-full">
			{/* Main Content */}
			<div className={clsx("flex flex-col items-center transition-all duration-300", showFileExplorer ? "w-2/3" : "w-full")}>
				<LayoutGroup>
			...
			<Button
				onClick={() => {
					console.log('🔘 File explorer toggle clicked, current state:', showFileExplorer);
				...
				variant="outline"
			>
				{showFileExplorer ? <X className="h-4 w-4" /> : <FolderOpen className="h-4 w-4" />}
			</Button>
